...
Probability to not have COVID-19 when the test is negativity.

Often the sensitivity is around 90% and the specifity is aroung 99%. What does that mean?
...
We still get a warning, but without very high coefficients. Check later. 
...
This only works with *meta-data* (columns names and types) so far! 
...
**Conclusion:** It is not as good compare to AUC 0.86
