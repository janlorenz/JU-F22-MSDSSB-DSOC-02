...
## Step 2: Copy the template file {.smaller}
...
- The first team member:
  ...
  - Add the file in the Git pane, commit with message "Author name". **Pull.**
  - This should result in a successful merge where both changes are there:
