...
:::{.callout-note}
First do the exercises in R in **hw-02-R.qmd**. 
Afterwards go through **hw-02-py.qmd**. This documents contains some tips how to do the same operations in python. Exercises which are not about coding can be omitted there. 
:::
## Data overview
