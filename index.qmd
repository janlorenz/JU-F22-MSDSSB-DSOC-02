...
Additionally, the handbook list a *requirement* to pass the module and a *bonus* option to increase the grade by 0.33 (while making the best grade is also possible with a great project report without the bonus). 
...
## Week 9, Oct 27: Classification Problems, Logisitc Regression, Prediction {-}
